...
})({"gczin":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c54808a5cc585466";
"use strict";
...
},{}],"8xX04":[function(require,module,exports,__globalThis) {
...
async function fetchImage() {
    ...
    fetch(`${"https://cataas.com/cat?type=medium&fit=contain&position=center&json=true"}`).then((response)=>{
        if (!response.ok) throw new Error('Network response was not ok');
        return response.json();
    }).then((data)=>{
        console.log('This is the payload', data);
        if (!data || Object.keys(data).length === 0) throw new Error('Data payload not received');
...
document.addEventListener('mousemove', (event)=>{
    ...
    pupils.forEach((pupil)=>{
        ...
        } else pupil.style.transform = `translate(${diffX}px, ${diffY}px)`;
    });
});

},{}]},["gczin","8xX04"], "8xX04", "parcelRequire8661", {})

//# sourceMappingURL=Catastic-Memes-Generator.cc585466.js.map
